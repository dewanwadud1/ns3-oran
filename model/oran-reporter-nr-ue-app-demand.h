 ...
 */
#ifndef ORAN_REPORTER_NR_UE_APP_DEMAND
#define ORAN_REPORTER_NR_UE_APP_DEMAND
 ...
 */
class OranReporterNrUeAppDemand : public OranReporter
{
  public:
    static TypeId GetTypeId();
    OranReporterNrUeAppDemand();
    ~OranReporterNrUeAppDemand() override;
...
#endif // ORAN_REPORTER_NR_UE_APP_DEMAND
