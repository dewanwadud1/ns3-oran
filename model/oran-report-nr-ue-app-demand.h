 ...
 */
#ifndef ORAN_REPORT_NR_UE_APP_DEMAND
#define ORAN_REPORT_NR_UE_APP_DEMAND
 ...
 */
class OranReportNrUeAppDemand : public OranReport
{
  public:
    static TypeId GetTypeId();
    OranReportNrUeAppDemand();
    ~OranReportNrUeAppDemand() override;
...
}; // class OranReportNrUeAppDemand

} // namespace ns3

#endif // ORAN_REPORT_NR_UE_APP_DEMAND
