 ...
 * Updated for ns-3.42: energy module moved to ns3::energy:: namespace.
 *
...
OranRuPowerModel::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::OranRuPowerModel")
    ...
    .AddAttribute ("SleepThresholdDbm",
                   "TxPower (dBm) at/below which RU is sleeping.",
                   DoubleValue (0.0),
...
OranRuPowerModel::GetPowerW (double txPowerDbm) const
{
  ...
  return (lossesEff > 0.0) ? (totalNoLoss / lossesEff) : std::numeric_limits<double>::infinity ();
}

double
OranRuPowerModel::GetCurrentA (double txPowerDbm) const
{
  return GetPowerW (txPowerDbm) / m_vdc;
}
...
OranRuDeviceEnergyModel::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::OranRuDeviceEnergyModel")
    ...
    .AddAttribute ("LteEnbPhy",
                   "Optional pointer to the eNB PHY.",
...
void
OranRuDeviceEnergyModel::SetEnergySource (Ptr<energy::EnergySource> source)
{
...
{
  NS_ASSERT_MSG (m_model != nullptr, "OranRuDeviceEnergyModel: no OranRuPowerModel set");
...
void OranRuDeviceEnergyModel::ChangeState (int) {}

void OranRuDeviceEnergyModel::HandleEnergyDepletion ()
{
  NS_LOG_INFO ("OranRuDeviceEnergyModel: Energy depleted");
}

void OranRuDeviceEnergyModel::HandleEnergyRecharged ()
{
  NS_LOG_INFO ("OranRuDeviceEnergyModel: Energy recharged");
}

void OranRuDeviceEnergyModel::HandleEnergyChanged () {}
