 ...
 */
/**
 * NR (5G) counterpart of oran-lte-2-lte-distance-handover-helper-example.cc.
 * OranHelper-based RIC wiring; OranLmNr2NrDistanceHandover.
 */
...
NS_LOG_COMPONENT_DEFINE("OranNr2NrDistanceHandoverHelperExample");
...
main(int argc, char* argv[])
{
    ...
    double speed = 5;
    bool verbose = false;
    std::string dbFileName = "oran-nr-distance-handover-helper-repository.db";
    ...
    // ── ORAN Models -- BEGIN (OranHelper wiring) ─────────────────────────────
