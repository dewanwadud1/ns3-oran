 ...
 * Demonstrates a custom LM query trigger; OranLmNr2NrDistanceHandover.
 */
...
NS_LOG_COMPONENT_DEFINE("OranNr2NrDistanceHandoverLmQueryTriggerExample");
...
CustomLmQueryTriggerCallback(Ptr<OranReport> report)
{
    ...
    Vector center = Vector(100, 0, 1.5);
...
main(int argc, char* argv[])
{
    ...
    double speed = 5;
    bool verbose = false;
    std::string dbFileName = "oran-nr-distance-handover-query-trigger-repository.db";
