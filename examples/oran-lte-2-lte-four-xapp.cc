...
/**
 * Developed by Abdul Wadud
 * The work was done as part of Abdul's Ph.D. study
 */
...
NS_LOG_COMPONENT_DEFINE("NewOranFourlm");

/**
 * Example of the ORAN models.
 *
 * The scenario consists of 20 LTE UEs moving in various mobility patterns among four different eNBs. The LTE UE reports to the RIC its location
