 ...
 *
 * Exercises: OranLmLte2LteEnergySaving, OranReporterLteEnergyEfficiency,
 *            OranCommandLte2LteTxPower, OranRuDeviceEnergyModel,
 *            SaveLteEnergyRemaining / GetLteEnergyRemaining DB APIs.
 *
 * Topology: 2 eNBs placed 50 m apart, 1 UE moving back and forth.
 *           Each eNB has a BasicEnergySource + OranRuDeviceEnergyModel.
 *           The Near-RT RIC runs OranLmLte2LteEnergySaving every 5 s.
...
NS_LOG_COMPONENT_DEFINE("OranLte2LteEnergySavingExample");
...
main(int argc, char* argv[])
{
    ...
    bool dbLog = false;
    std::string dbFileName = "oran-energy-saving-repository.db";
